...
<body>
    ...
    <section class="container" id="c1">
        ...
        <?php
            ...
            $trip_feature = "SELECT DISTINCT t.tripID, start_date, t.image, current_people, title, t.description, price FROM trip t, theme h WHERE t.themeID = h.themeID AND h.themeID = '$themeID' AND start_date > sysdate() AND featuredID != 'NULL' AND start_date > sysdate()";
    ...
    <section class="container" id="c2">
        ...
        <?php
            ...
            $trip = "SELECT DISTINCT tripID, start_date, t.image, current_people, title, t.description, price FROM trip t, theme h WHERE t.themeID = h.themeID AND h.themeID = '$themeID' AND start_date > sysdate() AND sysdate() <= featured_exp;";
