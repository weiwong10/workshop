...
<body>
    ...
    <section class="container" id="c1">
        ...
        <?php
            ...
            $trip_feature = "SELECT DISTINCT start_date, t.image, current_people, title, t.description, t.price FROM trip t, travel_itinerary i, travel_spot s WHERE s.spotID = i.spotID AND i.tripID = t.tripID AND s.spotID= '".$spotID."' AND start_date > sysdate() AND featuredID != 'NULL' AND sysdate() <= featured_exp;";
    ...
    <section class="container" id="c2">
        ...
        <?php
            ...
            $trip = "SELECT DISTINCT start_date, t.image, current_people, title, t.description, t.price FROM trip t, travel_itinerary i, travel_spot s WHERE s.spotID = i.spotID AND i.tripID = t.tripID AND s.spotID= '".$spotID."' AND start_date > sysdate();";
